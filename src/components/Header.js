        ...
        <header>
            <div className="header">
                ...
                <div className="header__contact header__social">
                    <a className="header__link" href="https://www.facebook.com/digitalsolution.web"><ImFacebook2 className="header__icon" /></a>
                    <a className="header__link" href="https://www.instagram.com/digitalsolution_web/?igshid=31pkfchkf6cd"><ImInstagram className="header__icon" /></a>
                    <a className="header__link" href="https://www.linkedin.com/in/digital-solution-6581831bb/"><ImLinkedin className="header__icon" /></a>
                </div>
            </div>
        </header>
    )
